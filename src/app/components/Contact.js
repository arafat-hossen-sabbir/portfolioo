          ...
          <AnimateIn direction="left">
            <div>
              <div style={{
                ...
                <p style={{ fontSize: 14, color: 'var(--accent)', fontWeight: 600, marginBottom: 20 }}>
                  {personalInfo.role}
                </p>
                <p style={{ fontSize: 14, color: 'var(--text-muted)', lineHeight: 1.7, marginBottom: 28 }}>
                  I'm a skilled Frontend developer specializing in building dynamic and responsive web applications using React, Next.js & Tailwind CSS.
                </p>
              ...
              <div style={{
                ...
                <p style={{ fontSize: 13, fontWeight: 700, color: 'var(--text-muted)', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 14 }}>
                  Find Me In
                </p>
                <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                  {[
                    { label: 'GitHub', href: personalInfo.social.github, color: '#333' },
                    { label: 'LinkedIn', href: personalInfo.social.linkedin, color: '#0a66c2' },
                    { label: 'Twitter', href: personalInfo.social.twitter, color: '#1da1f2' },
                    { label: 'Fiverr', href: personalInfo.fiverr, color: '#1dbf73' },
                  ].map((s, i) => (
                    <a
                      key={i}
                      href={s.href}
